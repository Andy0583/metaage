...
<a class="news-card" href="https://www.ithome.com.tw/pr/177462" target="_blank">
  ...
  <div class="news-desc">生成式 AI 正以驚人速度改變企業的資料使用與營運模式，而 Dell PowerStore Elite 正是專為此趨勢量身打造的「持續現代化」儲存平臺。</div>
</a>
...
[Dell Connectrix Target Code](https://www.dell.com/support/kbdoc/en-us/000228560/minimum-recommended-and-latest-code-versions-for-networking-products)<br>
[Dell PowerStore Target Code](https://www.dell.com/support/kbdoc/zh-tw/000175213/powerstoreos-matrix)<br>
...
!!! info "聯絡資訊"
    <div style="display: flex; align-items: center; justify-content: center; gap: 16px;">
      <a href="images/logo.png" target="_blank">
        <img src="images/logo.png" alt="Andy Hsu" style="width: 140px; height: 140px; border-radius: 50%; object-fit: cover; flex-shrink: 0; cursor: pointer;">
      </a>
